 ...
 */
class SubCategories extends \AP\EsoreBundle\Entity\SubCategories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AP\\EsoreBundle\\Entity\\SubCategories' . "\0" . 'products', '' . "\0" . 'AP\\EsoreBundle\\Entity\\SubCategories' . "\0" . 'categories', '' . "\0" . 'AP\\EsoreBundle\\Entity\\SubCategories' . "\0" . 'id', '' . "\0" . 'AP\\EsoreBundle\\Entity\\SubCategories' . "\0" . 'subCatName');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SubCategories $proxy) {
    ...
    public function setSubCatName($subCatName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSubCatName', array($subCatName));

        return parent::setSubCatName($subCatName);
    }
    ...
    public function getSubCatName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSubCatName', array());

        return parent::getSubCatName();
    }
