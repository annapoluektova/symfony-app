...
use AP\EsoreBundle\Entity\Categories;
use AP\EsoreBundle\Form\CategoriesType;
...
class CategoriesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('APEsoreBundle:Categories')->findAll();
     ...
     * @Method("POST")
     * @Template("APEsoreBundle:Categories:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('APEsoreBundle:Categories')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("APEsoreBundle:Categories:edit.html.twig")
     */
