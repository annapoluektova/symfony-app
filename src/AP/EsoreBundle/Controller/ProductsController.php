...
use AP\EsoreBundle\Entity\Products;
use AP\EsoreBundle\Form\ProductsType;
...
class ProductsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('APEsoreBundle:Products')->findAll();
     ...
     * @Method("POST")
     * @Template("APEsoreBundle:Products:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('APEsoreBundle:Products')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("APEsoreBundle:Products:edit.html.twig")
     */
